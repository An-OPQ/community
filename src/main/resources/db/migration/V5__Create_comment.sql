...
CREATE TABLE `comment` (
  ...
  `commentDate` varchar(11) DEFAULT NULL,
  `likeCount` varchar(11) DEFAULT '0',
  `commentCount` varchar(11) DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `creatorId` (`creatorId`),
  KEY `questionId` (`questionId`),
  CONSTRAINT `comment_ibfk_1` FOREIGN KEY (`creatorId`) REFERENCES `userinfo` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `comment_ibfk_2` FOREIGN KEY (`questionId`) REFERENCES `question` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
