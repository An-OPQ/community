...
document.writeln("                    <input type=\'text\' id='search' class=\'form-control\' placeholder=\'搜索\' value=\'\' disabled='disabled' >");
document.writeln("                </div>");
document.writeln("                <button type=\'button\' class=\'btn btn-default\' id='searchSubmit' disabled='disabled'>搜索</button>");
